...
void AstPrinter::PrintExpression(std::ostream& stream, const ExpressionRef& expr_ptr, const SymbolTable& table){
	...
	case ExpressionType::StringLiteral: {
		StringLiteralExpression *literal = (StringLiteralExpression*)expr;
		stream << "BoolLiteral: $'" << (table[literal->Value]) << "'\n";
	}break;
	...
	case ExpressionType::UnaryOperator: {
		...
		stream << UnaryOperatorTypeString(unary->UnaryType) << "Operator\n";
		Indent();
		PrintIndent(stream);
